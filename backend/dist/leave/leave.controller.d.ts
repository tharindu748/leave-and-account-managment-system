...
export declare class LeaveController {
    ...
    getLeaveRequests(userId?: string): Promise<({
        user: {
            name: string;
            jobPosition: string | null;
            email: string;
    ...
    getCalendarData(year?: string, month?: string): Promise<{
        leaves: {
            id: string;
            date: string;
    ...
    approveLeaveRequest(data: ApproveLeaveRequestDto): Promise<{
        user: {
    ...
    cancelLeaveRequest(data: CancelLeaveRequestDto): Promise<{
        user: {
            employeeId: string | null;
            name: string;
            cardNumber: string | null;
    ...
    getLeavePolicy(): Promise<{
        leaveType: import("@prisma/client").$Enums.LeaveType;
        defaultBalance: number;
    }[]>;
    updateLeavePolicy(data: UpdateLeavePolicyDto): Promise<{
        message: string;
    }>;
